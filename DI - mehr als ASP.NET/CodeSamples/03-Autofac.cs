...
namespace AutofacBeispiele
{
    ...
    // Ermöglicht die Erstellung von Instanzen auf Abruf
    // Ideal, wenn ein Service nicht sofort, mehrfach oder 
    // situationsabhängig erzeugt werden soll
    ...
    // Autofac kann auch Properties automatisch befüllen, 
    // wenn sie entsprechend konfiguriert sind.
    // Gut für optionale/ergänzende Services (z. B. Logging), 
    // weniger gut für Kernabhängigkeiten
    // Weniger fette Konstruktoren (-> Legacy Code!),
    // aber Vorsicht: Abhängigkeiten sind nicht mehr explizit sichtbar!
    public class ServiceWithPropertyInjection
    {
        // Kein Konstruktor, Logger wird über 
        // Property Injection bereitgestellt
